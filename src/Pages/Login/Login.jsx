...
const Login = () => {
    const { loginUsers, googleUsers } = use(AuthContext)
            ...
            <div className="hero min-h-screen">
                <div className="hero-content flex-col lg:flex-row-reverse">
                    <div className="text-center lg:text-left">
                        <div>
                            <Lottie animationData={loginJson} className='h-[500px]'></Lottie>
                        </div>
                    </div>
                        ...
                        <div className="card-body">
                            ...
                            <form onSubmit={handleEmailLogin}>
                                <fieldset className="fieldset pb-1">
                                    ...
                                    <input type="submit" className="btn btn-neutral mt-4 w-full" value="Login" />
                                </fieldset>
                            </form>
                            <p>Don't have an account? Please <NavLink to='/register'><span className='text-blue-400 font-medium'>Register</span></NavLink></p>
                        </div>
                    </div>
                </div>
            </div>
